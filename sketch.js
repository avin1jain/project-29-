...
function setup() {
  ...
  box1=new Box(400,475,50,50);
  box2=new Box(450,475,50,50);
  box3=new Box(500,475,50,50);
  box4=new Box(550,475,50,50);
  box5=new Box(600,475,50,50);
  box6=new Box(450,425,50,50);
  box7=new Box(500,425,50,50);
  box8=new Box(550,425,50,50);
  box9=new Box(500,375,50,50);
  ...
  ground2 = Bodies.rectangle(900, 300, 300,10 , {isStatic:true} );
   World.add(world, ground2);
	...
	groundSprite=createSprite(500, 500, 300,10);
	groundSprite.shapeColor=color("green")

	ground = Bodies.rectangle(500, 500, 300,10 , {isStatic:true} );
